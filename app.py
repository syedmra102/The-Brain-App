...
with st.form("daily_tasks_form", clear_on_submit=True):
    ...
    for task in tasks:
        if st.checkbox(task, key=f"task\_{hash(task)}"):
...
st.session_state.page = "signin"
st.rerun()
hey can u foxed in this code whenever I refresh the page I logout and he asked me for login again can u foxed this in m code and dotn change nothing else !!
